...
\begin{algorithmic}
  ...
  \State \algorithmicrequire{Article $a_\tau$}
  \State Preprocess $a_\tau$ to mine relevant actors and topics
  \ForAll{article $a_t$ st. $t \geq \tau - P$}
